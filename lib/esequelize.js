...
class ESequelize extends Sequelize {
  constructor(config) {
...
ESequelize.Model = class extends Sequelize.Model {
...
Object.assign(ESequelize.prototype, EventEmitter.prototype);

module.exports = ESequelize;
